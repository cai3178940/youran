 ...
 * @date 2020/04/04
 */
public class MetaChartExample {

    public static final String N_CHART_ID = "主键ID";
    public static final String E_CHART_ID = "1";
    public static final String N_PROJECT_ID = "项目id";
    public static final String E_PROJECT_ID = "1";
    public static final String N_SOURCE_ID = "数据源id";
    ...
    public static final String E_TITLE = "示例图表";
