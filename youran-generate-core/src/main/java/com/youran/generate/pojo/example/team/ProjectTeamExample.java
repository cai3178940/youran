package com.youran.generate.pojo.example.team;
...
public class ProjectTeamExample {
    ...
    public static final String N_TEAM_ID = "主键ID";
    public static final String E_TEAM_ID = "1";
    public static final String N_NAME = "名称";
    public static final String E_NAME = "rmb开发组";
