...
public class MetaFieldExample {
    ...
    public static final String E_AUTOINCREMENT = "1";
    ...
    public static final String N_FIELDLENGTH = "表字段长度";
    public static final String E_FIELDLENGTH = "19";
    public static final String N_FIELDNAME = "表字段名称";
    public static final String E_FIELDNAME = "id";
    public static final String N_FIELDSCALE = "表字段精度";
    ...
    public static final String N_JFIELDTYPE = "实体字段类型";
    public static final String E_JFIELDTYPE = "Integer";
    public static final String N_LIST = "是否列表展示字段";
    ...
    public static final String N_SHOW = "是否详情展示字段";
    public static final String E_SHOW = "1";
    public static final String N_UPDATE = "是否手动更新字段";
