...
public class MetaCodeGenControllerTest extends AbstractWebTest {
    ...
    private MetaFieldPO delSignField;
    ...
    public void buildMetadata(){
        ...
        this.delSignField = generateHelper.saveDelSignField(this.userEntity);
        this.createDateField = generateHelper.saveCreateDateField(this.userEntity);
        this.createByField = generateHelper.saveCreateByField(this.userEntity);
        this.operateDateField = generateHelper.saveOperateDateField(this.userEntity);
        this.operateByField = generateHelper.saveOperateByField(this.userEntity);
