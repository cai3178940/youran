...
**id类型**：可选择长整型bigint和整型int两种，一般情况使用整型int即可
    `,
    feature: `
**实体功能**： 当前实体如何维护与另一个实体的关联关系，
通常情况下只需要设置“**随实体一起维护**”或“**设置关联**”中的一个即可

- 随实体一起维护： 在创建或修改当前实体的同时，可指定关联关系，会在同一个事务中维护多对多关联关系
- 设置关联： 针对已经存在的实体，可直接调用设置关联关系的服务，该服务适用于关联实体数量不是很庞大的业务场景
- 添加+移除： 单独生成两个服务（添加关联、移除关联），适用于关联实体数量比较庞大的场景
