      ...
      <el-col :span="12">
        <el-form ref="showForm" class="showForm" :model="form" label-width="120px">
          <el-form-item label="java字段名" prop="jfieldName">
            <el-input :disabled="true" v-model="form.jfieldName" placeholder="java字段名，例如：age"></el-input>
          </el-form-item>
          <el-form-item label="mysql字段名" prop="fieldName">
            <el-input :disabled="true" v-model="form.fieldName" placeholder="mysql字段名，例如：age"></el-input>
          </el-form-item>
          <el-form-item label="字段描述" prop="fieldDesc">
            <el-input :disabled="true" v-model="form.fieldDesc" placeholder="字段描述，例如：年龄"></el-input>
          </el-form-item>
          <el-form-item label="java字段类型" prop="jfieldType">
            <el-select :disabled="true" v-model="form.jfieldType" style="width:100%;" filterable placeholder="请选择">
              <el-option
          ...
          <el-form-item label="mysql字段类型" prop="fieldType">
            <el-select :disabled="true" v-model="form.fieldType" style="width:100%;" filterable placeholder="请选择">
              <el-option
          ...
          <el-form-item label="字段长度" prop="fieldLength">
            <el-input-number :disabled="true" v-model="form.fieldLength" style="width:100%;" :min="0" placeholder="字段长度，例如：10"></el-input-number>
          </el-form-item>
          <el-form-item label="字段精度" prop="fieldScale">
            <el-input-number :disabled="true" v-model="form.fieldScale" style="width:100%;" :min="0" placeholder="字段精度，例如：2"></el-input-number>
          </el-form-item>
          ...
          <el-form-item label="字段示例" prop="fieldExample">
            <el-input :disabled="true" v-model="form.fieldExample" placeholder="字段示例，例如年龄字段：21"></el-input>
          </el-form-item>
          <el-form-item label="字段备注" prop="fieldComment">
            <el-input :disabled="true" v-model="form.fieldComment" type="textarea" :rows="2" placeholder="字段备注，例如：年龄【整型】"></el-input>
          </el-form-item>
          ...
          <el-form-item label="查询方式" prop="queryType">
            <el-select :disabled="true" v-model="form.queryType" style="width:100%;" filterable placeholder="请选择">
              <el-option
          ...
          <el-form-item label="特殊字段类型" prop="specialField">
            <el-select :disabled="true" v-model="form.specialField" style="width:100%;" filterable placeholder="请选择">
              <el-option
